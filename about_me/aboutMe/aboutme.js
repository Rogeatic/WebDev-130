...
indList.innerHTML = `<div id="foods"><br><br><p1>Favorite Foods:</p1> <li>${FavoriteFoodsList[0]} </li>
    <li>${FavoriteFoodsList[1]} </li> <li>${FavoriteFoodsList[2]} </li><li>${FavoriteFoodsList[3]} </li></div>`;
